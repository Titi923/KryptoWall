    ...
    <div className="flex w-full- justify-center">
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 p-12 px-4">
        <div className="flex flex-1 justify-start flex-col mf:mr-10">
          <h1 className="text-3xl sm:text-5xl text-white text-gradient padding-y-1 ">
          ...
          <div className="grid sm:grid-cols-3 grid-cols-2 w-full mt-10">
            ...
            <div className={`rounded-bl-2xl ${commonStyles}`}>Reliability</div>
            ...
            <div className="flex justify-between flex-col w-full h-full">
              <div className="flex justify-between items-center">
                <div className="w-10 h-10 rounded-full border-2 border-white flex justify-center items-center">
                  <SiEthereum fon-size={21} color="#fff" />
                </div>
                <BsInfoCircle fontSize={17} color="#fff" />
              </div>
              <div>
                <p className="text-white font-light text-sm">0xjw...d8fa</p>
